function fetchMovieDataByTitle(title) {
    return movieData.filter(movie => movie.title.toLowerCase() === title.toLowerCase())[0];
}
...
function displayMovieDetails(movie) {
    ...
    imageElement.src = movie.big_image;
    ...
    titleElement.style.fontFamily = "Brush Script MT";

    const descriptionElement = document.createElement("p");
    descriptionElement.textContent = movie.description;
    descriptionElement.style.fontSize = "30px";
    descriptionElement.style.fontFamily = "Brush Script MT";

    const ratingElement = document.createElement("p");
    ratingElement.textContent = "Rating: " + movie.rating;
    ratingElement.style.fontSize = "30px";
    ratingElement.style.fontFamily = "Brush Script MT";

    const yearElement = document.createElement("p");
    yearElement.textContent = "Year: " + movie.year;
    yearElement.style.fontSize = "30px";
    yearElement.style.fontFamily = "Brush Script MT";

    const genreElement = document.createElement("p");
    genreElement.textContent = "Genre: " + movie.genre.join(", ");
    genreElement.style.fontSize = "30px";
    genreElement.style.fontFamily = "Brush Script MT";
    ...
    movieDetailsContainer.appendChild(gridContainer);
}
...
function searchMovie() {
    ...
    if (searchTerm === "") {
        ...
        hidedata.style.display = "display";

        return;
    }

    const movie = fetchMovieDataByTitle(searchTerm);
    if (movie) {
...
// Sample movie data (replace with your actual data or fetch from an API)
const movieData = [
    {
        "rank": 1,
